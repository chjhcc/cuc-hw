...
class Bullet(object):
    def __init__(self, screen_temp, x, y):  # 构造方法 初始化子弹对象的属性
        ...
        self.image = pygame.image.load("./images/images/bullet.png")  # 创建一个子弹图片
...
class Aircraft_obj(object):
    def __init__(self, screen_temp):  # 构造方法 初始化飞机对象的属性
        ...
        self.y = 708  # 飞机起始Y坐标
        self.screen = screen_temp  # 窗口
        self.image = pygame.image.load("./images/images/hero1.png")  # 创建一个飞机图
...
class EnemyPlane(object):
    def __init__(self, screen_temp):  # 构造方法 初始化敌机对象的属性
        ...
        self.y = 0  # 敌机的起始Y坐标
        self.screen = screen_temp  # 窗口
        self.image = pygame.image.load("./images/images/enemy0.png")  # 创建一个敌机图片
    ...
    def __crate_images(self):  # 将爆炸需要的图片添加到self.bomb_lists中
        self.bomb_lists.append(pygame.image.load("./images/images/enemy0_down1.png"))
        self.bomb_lists.append(pygame.image.load("./images/images/enemy0_down2.png"))
        self.bomb_lists.append(pygame.image.load("./images/images/enemy0_down3.png"))
        self.bomb_lists.append(pygame.image.load("./images/images/enemy0_down4.png"))
    ...
    for event in pygame.event.get():
        ...
        # 判断是不是键盘按下事件
            ...
            #检测按键是不是w或者up
                ...
                print('UP')  # 输出“up”
                aircraft_temp.move_up()  # 执行飞机上移方法
            #检测按键说是不是s或者down
            elif event.key == K_s or event.key == K_DOWN:
                print('down')  # 输出“down”
                aircraft_temp.move_down()  # 执行飞机下移方法
            # 检测按键是不是空格键
...
def main():
    ...
    # 2. 创建一个背景图片
    background = pygame.image.load("./images/images/background.png")
